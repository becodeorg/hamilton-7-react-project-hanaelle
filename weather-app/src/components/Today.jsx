...
const Today = ({data, weatherUnits}) => {
    ...
    return (
        <div className="max-w-max mx-auto xl:ml-auto ">
            {" "}
            {/*responsive avec marges diff pour chaque ecran */}
            <div className="flex mb-20 mt-12 flex-col xl:flex-row">
                {" "}
                {/* mettre emojis et texte et donnees d uncote et le reste de l autre sur une colonne  */}
                <div className="flex flex-col">
                    {" "}
                    {/*aligner les emojis l un en desou de l autre */}
                ...
                <div className="text-xl ml-12 xl:pl-4 xl:border-l-2 xl:border-l-indigo-500">
                    ...
                    <p>
                        {emojis.hot} Temperature Max :{" "}
                        {data.precipitation_2m_max} {weatherUnits.temperature}
                    </p>
                    <p>
                        {emojis.hot} Temperature Min :{" "}
                        {data.precipitation_2m_min} {weatherUnits.temperature}
                    </p>
                    <p>
