export const formatWeatherDataDaily = (data) => {   // ici j exporte le tableau qui correspont au jour de la semaien avec chaque unite (temp, degres, vent etc...)
    ...
    dataEntries.forEach((key, keyIndex) => {
        for (let i = 0; i < data[key].length; i++) {                    //dans cette boucle FOR une passe sur le tableau des jours pour definir chaque valeur
            if(keyIndex === 0) {                                         // SI key Index est = 0 c est a dire commencer le 1 err tour du tableau 
    ...
    dataDaily.forEach((data) => {                                            // jour en Francais
